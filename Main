...
Notification:Notify(
    {Title = "Notification", Description = "Goto Use BlackKing Now!"},
    {OutlineColor = Color3.fromRGB(255,255,255),Time = 5, Type = "image"},
    {Image = "http://www.roblox.com/asset/?id=13429676701", ImageColor = Color3.fromRGB(255, 255, 255)}
)

Notification:Notify(
    {Title = "Notification", Description = "ez.run <BlackKing.run>"},
